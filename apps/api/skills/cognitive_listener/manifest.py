...
4. Call update_user_interests(interests) when the user wants to permanently add or change their core preferences.
5. The items will appear in the Review Center.
""",
    triggers=[
        "monitor news", "track trends", "add topic listener", 
        "watch for updates", "what's new in", "flag new features",
        "latest features", "AI trends", "tech news", "add to my preferences",
        "update my interests", "primary topics"
    ],
    tools=TOOLS,
